...
export const PROBE_CATALOGUE: ProbeDefinition[] = [
  ...
  {
    id: "kiro/auth",
    description: "kiro-cli is logged in, so a run cannot hang in its browser login.",
    level: "fast",
    backends: ["kiro"],
  },
  {
    id: "kiro/models-available",
    description: "Every model the run uses is offered on the account's kiro plan.",
    level: "fast",
    backends: ["kiro"],
  },
  {
  ...
  },
  {
    ...
    level: "full",
    backends: ["cursor", "claude", "kiro", "codex"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Only file tools and Bash are available; no web, subagents, or MCP.",
    level: "full",
    backends: ["claude"],
  },
  {
