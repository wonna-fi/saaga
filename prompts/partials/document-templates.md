...
Every document follows the template for its type. Match the structure exactly so
verification can compare against it. Adapt code examples, file references, and
...
{include:partials/feature-template.md}
