...
| [CLI Entry Point](./cli-entry-point.md) | How the seven subcommands parse arguments, resolve the agent, create a run context, and execute flows |
...
| [Slice Workflow](./slice-workflow.md) | Standalone single-phase documentation with verify/fix loop |
| [Architecture Generation](./architecture-generation.md) | Single-step flow that produces `ARCHITECTURE.md` |
